...
rdfcapitalizer = RDFTranslator('../temp/faecherklassifikation_en_manual.ttl', 'de', 'en')
names = rdfcapitalizer.capitalizenames('en')

print("Serializing capitalized graph to turtle format")
with open('../faecherklassifikation_skos_en.ttl', 'w') as file_object:
    file_object.write(names.serialize())

print("Serializing graph to XMl/RDF")
with open('../faecherklassifikation_skos_en.rdf', 'w') as file_object:
    file_object.write(names.serialize(format='xml'))

print("Serializing graph to n3 format")
with open('../faecherklassifikation_skos_en.n3', 'w') as file_object:
